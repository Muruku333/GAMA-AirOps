...
export default function DashboardAppPage({DB_URL}) {
  ...
  return (
    <>
      <Helmet>
        <title> Dashboard | GAMA AirOps </title>
      </Helmet>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={12} md={12}>
            <AppWidgetSummary title="Total Users" total={users ? users : '0'} icon={'mdi:users'} />
          </Grid>

          <Grid item xs={12} sm={12} md={12}>
            <AppWidgetSummary title="Total Quotations" total={quotes ? quotes :'0'} color="info" icon={'ant-design:file-text-filled'} />
          </Grid>
          </Grid>
          </Grid>

...
// Aircraft Components
import {CreateAirport, ListAirport, EditAirport } from '../../sections/@dashboard/masters/airport';
    ...
    return(
        ...
        <TabContext value={value} sx={{padding:0}}>
          <TabPanel value="1" sx={{padding:0}}> 
            <ListAirport handleTabChange={handleTabChange} handleEditClick={handleEditClick} userData={userData}/>
          </TabPanel>

...
export default function DeleteModel(props){
    ...
    const handleDeleteAircraftModel = async ()=>{
        try {
            await axios.delete(`${API_URL}/api/aircraft_models/${idToDelete}`).then((response)=>{
    ...
    return <>
      ...
      >
        ...
        <DialogActions>
          <Button color="error" variant="contained" onClick={()=>{handleDeleteAircraftModel();handleClose();}}>
            Delete
          </Button>

...
const TABLE_HEAD = [
  ...
  { id: "customer_name", label: "Code", alignRight: false },
  { id: "label", label: "City", alignRight: false },
  { id: "label", label: "Designation", alignRight: false },
  { id: "label", label: "Date Of Birth", alignRight: false },
...
const handleSelectAllClick = (event) => {
  if (event.target.checked) {
    const newSelecteds = crewRows.map((n) => n.quotation_no);
